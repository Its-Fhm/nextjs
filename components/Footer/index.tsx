// Mock data for footer links and social media links
const footerLinks = [
  { text: 'Blog', url: '/' },
  { text: 'Pricing', url: '/' },
  { text: 'About', url: '/' },
    ...
    <footer className="wow fadeInUp relative z-10 bg-primary bg-opacity-5 pt-16 md:pt-20 lg:pt-24" data-wow-delay=".1s">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
              ...
              <div className="flex items-center">
                {socialMediaLinks.map((link, index) => (
                  <a
                    key={index}
                    href={link.url}
                    aria-label={`social-link-${link.text}`}
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    {/* <SocialMediaIcon name={link.icon} /> */}
                  </a>
                ))}
              </div>
            </div>
          ...
          {/* Additional Links (Terms, Support, etc.) */}
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-3/12">
            <div className="mb-12 lg:mb-16">
              <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                Useful Links
      ...
      <div className="absolute right-0 top-14 z-[-1]">
        {/* ... (SVG code for the right-side decoration) */}
      </div>
      <div className="absolute left-0 bottom-24 z-[-1]">
        {/* ... (SVG code for the left-side decoration) */}
        <div className="absolute left-0 bottom-24 z-[-1]">
          <svg
            width="79"
            height="94"
